...
export const opts = optionMngr.options;

export const getLineNoise = function (width, height, options) {
...
export const getText = function (text, width, height, options) {
...
export const createCaptcha = function (text, options) {
...
export const createMathExpr = function (options) {
